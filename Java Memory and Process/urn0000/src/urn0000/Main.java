...
public class Main {
	...
	public static void main(String[] args) {	
        ...
        System.out.println("Allocating Segment [P1 S1] to Main Memory from Process " + p1.toString());
        ...
        System.out.println("Start Component B.2.1");
...
//        ArrayList<String>[] res = ps.parseInputString("5, [20; rwx], [70; r--], [50; -w-]");
//        for (int i =0; i<res.length; i++){
//			System.out.println(res[i].toString()+"<===ll");
//		}
